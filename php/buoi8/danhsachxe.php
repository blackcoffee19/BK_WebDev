...
<body>
    <header>
        <h1 align="center"><a href="danhsachxe.php">Sport & Muscle Car</a></h1>
    ...
    if(empty($_GET["page"])&&$_GET["p"] == ""){
      ...
      echo '<div class="carousel-inner">';
        echo '<div class="carousel-item active">';
          echo '<img src="'.$ds[1][0].'" class="d-block w-100" alt="...">';
        echo "</div>";
        for($i = 2 ; $i <count($ds);$i++){
        echo'<div class="carousel-item">';
          echo '<img src="'.$ds[$i][0].'" class="d-block w-100">';
        echo '</div>';
        }
    echo '</div>';
    ...
    echo '</table></div>';
    echo '<p style="font-weight:700; margin-left:20px;">TOTAL:&emsp;&emsp;&emsp; <font color="red">$</font><span style="color:red" id="total"></span></p>';
    echo '<a id="payment" href="?page=Payment">Payment</a></div>';
    echo "</div>";
    }
    ?>
    <footer>
