<?php require('dsx.php');
    if($_REQUEST["p"] == ""){
        ...
        echo "<input style='margin-top:20px;margin-bottom:50px;width:50%;margin-left:20px;outline-color:#FFFFFF;' type='text' placeholder='Search' id='search' name='p' onkeyup='searching(this.value)'></form>";
        $p = $_REQUEST["p"];
        $len = strlen($p);
        foreach($ds as $key => $value){
